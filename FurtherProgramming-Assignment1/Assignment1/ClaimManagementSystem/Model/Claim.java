...
public class Claim {
    ...
    public String toString() {
        ...
        stringBuilder.append("Claim Details:\n");
        stringBuilder.append(String.format("  - ID: %s\n", id));
        stringBuilder.append(String.format("  - Claim Date: %s\n", claimDate));
        stringBuilder.append(String.format("  - Insured Person: %s\n", insuredPerson.getName()));
        stringBuilder.append(String.format("  - Card Number: %s\n", cardNumber));
        stringBuilder.append(String.format("  - Exam Date: %s\n", examDate));
        stringBuilder.append(String.format("  - Claim Amount: %.2f\n", claimAmount));
